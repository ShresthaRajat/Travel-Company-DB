    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="#" title="cUSTOMER Details" class="tip-bottom"><i class="icon-home"></i>Customer</a>
            </div>
        </div>
        <!--End-breadcrumbs-->
        ...
        <div class="container">
            ...
            <form id="form1" runat="server">
                <div>
                    <asp:GridView ID="GridView1" CssClass="table table-bordered table-striped" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="CUSTOMER_ID" DataSourceID="SqlDataSource1">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ShresthaRajatConnection %>" DeleteCommand="DELETE FROM &quot;CUSTOMER&quot; WHERE &quot;CUSTOMER_ID&quot; = :CUSTOMER_ID" InsertCommand="INSERT INTO &quot;CUSTOMER&quot; (&quot;CUSTOMER_ID&quot;, &quot;FIRST_NAME&quot;, &quot;LAST_NAME&quot;, &quot;ADDRESS&quot;, &quot;PHONE_NO&quot;) VALUES (:CUSTOMER_ID, :FIRST_NAME, :LAST_NAME, :ADDRESS, :PHONE_NO)" ProviderName="<%$ ConnectionStrings:ShresthaRajatConnection.ProviderName %>" SelectCommand="SELECT * FROM &quot;CUSTOMER&quot;" UpdateCommand="UPDATE &quot;CUSTOMER&quot; SET &quot;FIRST_NAME&quot; = :FIRST_NAME, &quot;LAST_NAME&quot; = :LAST_NAME, &quot;ADDRESS&quot; = :ADDRESS, &quot;PHONE_NO&quot; = :PHONE_NO WHERE &quot;CUSTOMER_ID&quot; = :CUSTOMER_ID">
                        <DeleteParameters>
                ...
                <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("LAST_NAME") %>' />
                        <br />
                        ADDRESS:
                <asp:TextBox ID="TextBox3" runat="server" class="form-control" Text='<%# Bind("ADDRESS") %>' />
                        <br />
                        PHONE_NO:
                <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("PHONE_NO") %>' />
                        <br />
